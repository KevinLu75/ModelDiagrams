...
export class UmlComponentesComponent {
 ...
 this.diagram.nodeTemplateMap.add("subsistema",
    ...
    console.log("Diagrama de componentes inicializado");
  }
  ...
  initPalette() {
    ...
    console.log("Paleta de componentes inicializada");
  }
  ...
  guardarComoImagen(diagram: go.Diagram) {
    ...
    pdf.save("diagrama-componentes.pdf");
  }
  ...
  conectar() {
    ...
    if (selectedNodes.length !== 2) {
      ...
      this.toastr.warning('Debe seleccionar exactamente dos nodos para conectar', 'Atención');
      return;
    }
